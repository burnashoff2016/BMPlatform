...
const DigitalInclusionFullPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800">
      ...
      <nav className="bg-white dark:bg-slate-900 shadow-md py-4 px-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <div className="bg-blue-600 p-2 rounded-lg">
              <Globe className="text-white h-6 w-6" />
            </div>
            <h1 className="text-xl font-bold text-slate-800 dark:text-white">Цифровая инклюзивность ДФО</h1>
          </div>
          
          <div className="hidden md:flex space-x-4">
            <Link to="#" className="text-blue-600 dark:text-blue-400 font-medium border-b-2 border-blue-600 dark:border-blue-400 pb-1">Дашборд</Link>
            <Link to="/digital-inclusion-report" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Отчет</Link>
            <Link to="#" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Методология</Link>
            <Link to="#" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Рекомендации</Link>
          </div>
        ...
        {mobileMenuOpen && (
          <motion.div 
            ...
            className="md:hidden bg-white dark:bg-slate-800 shadow-lg rounded-lg mt-2 mx-6 py-4"
          >
            <div className="flex flex-col space-y-3 px-4">
              <Link to="#" className="text-blue-600 dark:text-blue-400 font-medium">Дашборд</Link>
              <Link to="/digital-inclusion-report" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Отчет</Link>
              <Link to="#" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Методология</Link>
              <Link to="#" className="text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Рекомендации</Link>
            </div>
      ...
      <footer className="bg-slate-800 text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-bold mb-4">Цифровая инклюзивность ДФО</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-300">
                <li><Link to="#" className="hover:text-white">Дашборд</Link></li>
                <li><Link to="/digital-inclusion-report" className="hover:text-white">Аналитический отчет</Link></li>
                <li><Link to="#" className="hover:text-white">Методология</Link></li>
                <li><Link to="#" className="hover:text-white">Рекомендации</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4">Ресурсы</h4>
              <ul className="space-y-2 text-slate-300">
                <li><a href="#" className="hover:text-white">WCAG 2.1</a></li>
                <li><a href="#" className="hover:text-white">ФЗ-419</a></li>
                <li><a href="#" className="hover:text-white">ГОСТ Р 52872-2019</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-300">
                <li>info@digitalinclusion-dfo.ru</li>
                <li>+7 (4212) 123-45-67</li>
                <li>г. Хабаровск, ул. Примерная, 1</li>
              </ul>
            </div>
          </div>
          <div className="border-t border-slate-700 mt-8 pt-8 text-center text-slate-400 text-sm">
            <p>© 2025 Цифровая инклюзивность органов власти ДФО. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
...
export default DigitalInclusionFullPage;